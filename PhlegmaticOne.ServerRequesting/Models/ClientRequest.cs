...
{
    protected ClientPostRequest(T requestData) : base(requestData)
    {
...
{
    protected ClientGetRequest(T requestData) : base(requestData)
    {
        RequestData = requestData;
    }
    public T RequestData { get; }
...
{
    protected EmptyClientGetRequest() : base(null)
    {
        IsEmpty = true;
    }

...
public interface IRepository<TEntity> where TEntity : EntityBase
{
    ...
    Task<TEntity> UpdateAsync(TEntity entity, Action<TEntity> actionOverExistingEntity, CancellationToken cancellationToken = new());
    Task<TEntity?> UpdateAsync(Guid entityId, Action<TEntity> actionOverExistingEntity, CancellationToken cancellationToken = new());
